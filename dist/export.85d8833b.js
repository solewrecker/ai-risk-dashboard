...
async function init() {
    ...
    // Initialize tab navigation, theme gallery, and marketplace
...
function initializeThemeGallery() {
    // Create a new ThemeConnector instance
    const themeConnector = new (0, _themeConnectorJsDefault.default)();
    // Store the ThemeConnector instance globally for access in other functions
    window.themeConnector = themeConnector;
    // Initialize the theme gallery UI
    themeConnector.initThemeGallery();
...
},{"../supabase-client.js":"eoCsO","./export/report-generation.js":"UkKb3","./export/themeSystem.js":"iPO2C","./export/themes/themeConfig.js":"iYXTd","./export/themeConnector.js":"2tUza","./export/themeMarketplace.js":"4d2ys","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"UkKb3":[function(require,module,exports,__globalThis) {
// docs/js/dashboard/export/report-generation.js
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Data preparation for Handlebars templates
parcelHelpers.export(exports, "prepareTemplateData", ()=>prepareTemplateData);
...
async function prepareReportData(selectedAssessmentIds, allAssessments, quickTemplates, selectedTemplate, currentMode, customSelectedSections, selectedTheme) {
    ...
    try {
        ...
        if (window.themeConnector) themeData = window.themeConnector.getThemeDataForReport();
...
},{"../../supabase-client.js":"eoCsO","handlebars":"9pFby","jspdf":"b6g54","html2canvas":"jgq02","qrcode":"9Qtts","lucide":"hPBbM","./templates.js":"9q6Gb","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9Qtts":[function(require,module,exports,__globalThis) {
...
},{"c36bbcf663291acc":"3xFLw"}],"9q6Gb":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "baseTemplate", ()=>baseTemplate);
parcelHelpers.export(exports, "footerTemplate", ()=>footerTemplate);
parcelHelpers.export(exports, "reportConfigs", ()=>reportConfigs);
parcelHelpers.export(exports, "themeConfigs", ()=>themeConfigs);
const baseTemplate = `
    <div class="container">
        <!-- Header -->
        <div class="header">
        ...
        <div class="premium-feature">
            <div class="premium-feature__icon">\u{2696}\u{FE0F}</div>
        ...
        <div class="premium-feature">
            <div class="premium-feature__icon">\u{1F4C8}</div>
            <div class="premium-feature__content">
...
`;
const footerTemplate = `<footer class="report-footer">
    <div class="report-footer__content">
        <div class="report-footer__section">
            <h3 class="report-footer__title">\u{1F4CB} Assessment Sources</h3>
        ...
        {{#if azurePermissions}}
        <div class="report-footer__section">
            <h3 class="report-footer__title">\u{2601}\u{FE0F} Azure Integration & Restrictions</h3>
        ...
        <div class="report-footer__section">
            <h3 class="report-footer__title">\u{1F4CA} Documentation Tier</h3>
        ...
        <div class="report-footer__section">
            <h3 class="report-footer__title">\u{2696}\u{FE0F} Legal Disclaimer</h3>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["4M0od","4IY3I"], "4IY3I", "parcelRequire4b35", {})
