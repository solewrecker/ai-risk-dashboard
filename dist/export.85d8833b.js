...
})({"275aw":[function(require,module,exports,__globalThis) {
...
var _themeSystemJs = require("./export/themeSystem.js");
var _themeConfigJs = require("./export/themes/themeConfig.js");
var _themeConnectorJs = require("./export/themeConnector.js");
var _themeConnectorJsDefault = parcelHelpers.interopDefault(_themeConnectorJs);
var _themeMarketplaceJs = require("./export/themeMarketplace.js");
var _themeMarketplaceJsDefault = parcelHelpers.interopDefault(_themeMarketplaceJs);
// --- State ---
let allAssessments = [];
...
const mixMatchSelector = document.querySelector('.custom-sections__selector'); // This is for custom sections
...
const previewStatus = document.querySelector('.export-preview__status');
...
async function init() {
    ...
    const { data: { session }, error: getSessionError } = await (0, _supabaseClientJs.supabase).auth.getSession();
    if (getSessionError) {
    ...
    (0, _supabaseClientJs.supabase).auth.onAuthStateChange(async (event, session)=>{
...
function initializeThemeMarketplace() {
    ...
    const themeMarketplace = new (0, _themeMarketplaceJsDefault.default)();
...
async function loadAssessments() {
    ...
    try {
        const { data, error } = await (0, _supabaseClientJs.supabase).from('assessments').select('*').order('created_at', {
            ascending: false
        });
        if (error) {
...
function setupEventListeners() {
    ...
    mixMatchSelector.addEventListener('change', (e)=>{
        if (e.target.type === 'checkbox') {
            ...
            // Toggle the custom-sections__toggle class for visual feedback
            const toggleContainer = e.target.closest('.custom-sections__toggle');
            if (toggleContainer) toggleContainer.classList.toggle('active', e.target.checked);
...
function updateUI() {
    ...
    sectionsToDisplay.forEach((section)=>{
        ...
        item.className = 'export-preview__item';
...
},{"../supabase-client.js":"eoCsO","./export/report-generation.js":"UkKb3","./export/themeSystem.js":"iPO2C","./export/themes/themeConfig.js":"iYXTd","./export/themeConnector.js":"2tUza","./export/themeMarketplace.js":"4d2ys","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["275aw","4IY3I"], "4IY3I", "parcelRequire4b35", {})
