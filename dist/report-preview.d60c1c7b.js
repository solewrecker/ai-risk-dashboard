...
(0, _handlebarsDefault.default).registerHelper('contains', function(str, substring, options) {
    if (str && str.includes && str.includes(substring)) return options.fn(this);
    return options.inverse(this);
});
(0, _handlebarsDefault.default).registerHelper('eq', function(a, b, options) {
    if (a === b) return options.fn(this);
    return options.inverse(this);
});
(0, _handlebarsDefault.default).registerHelper('gt', function(a, b, options) {
    if (a > b) return options.fn(this);
    return options.inverse(this);
});
...
async function renderReport({ primaryAssessment, selectedData, sectionsToGenerate, selectedTemplate, selectedTheme }) {
    ...
    try {
        ...
        function renderFooterSection(data) {
            const template = (0, _handlebarsDefault.default).compile((0, _templatesJs.footerTemplate));
            return template(data);
        }
