...
class TemplateBindingEngine {
    ...
    async exportPDFReport(assessmentData, templatePath = './templates/export-template.html') {
        ...
        try {
            // 2. Add html2canvas script dynamically to the head
            ...
            // 3. Generate the full HTML for the report
            const reportHtml = await this.generateHTMLReport(assessmentData, templatePath);
            
            // 4. Create a temporary, off-screen container to render the HTML
            ...
            // 6. Use jsPDF to create a PDF from the canvas
            ...
            // 8. Clean up the temporary elements
